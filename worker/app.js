        ...
        if (item['mimeType'] == 'application/vnd.google-apps.folder') {
           //if mimeType is folder do nathing...
            ...
            if ("|mp4|webm|avi|mpg|mpeg|mkv|rm|rmvb|mov|wmv|asf|ts|flv|".indexOf(`|${ext}|`) >= 0) {
                ...
                statments += "INSERT INTO `videos`(`playlist_id`, `user_id`, `name`, `description`, `url`, `duration`, `type`, `thumbnail`, `created_at`, `updated_at`, `featured`, `draft`, `downloads`, `views`) VALUES ("+playlist_id+","+user_id+",'"+name+"','Watch "+name+" from barf entertainment app.','"+p+"','"+duration+"',1,'"+thumbnail+"','"+datetime+"','"+datetime+"',0,"+draft+",0,0);";
            }
      ...
      if (item['mimeType'] == 'application/vnd.google-apps.folder') {
         //if mimeType is folder do nathing...
          ...
          if ("|mp4|webm|avi|mpg|mpeg|mkv|rm|rmvb|mov|wmv|asf|ts|flv|".indexOf(`|${ext}|`) >= 0) {
              ...
              payloads +=`{ "playlist_id": `+playlist_id+`,"user_id": `+user_id+`,"name": "`+name+`", "description": "Watch `+name+` from barf entertainment app.", "url": "`+p+`", "duration": "`+duration+`", "type": 1, "thumbnail": "`+thumbnail+`", "featured": 0, "draft": `+draft+`,"created_at":"`+datetime+`","updated_at":"`+datetime+`"},`;
